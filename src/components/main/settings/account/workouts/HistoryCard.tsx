import { IHistoryWorkout } from "@/src/interfaces/main/settings/account/workouts";
import { formatDateOnly, formatTimeOnly } from "@/src/lib/utils";
import Image from "next/image";

interface IProps {
  history: IHistoryWorkout;
}
function HistoryWorkoutCard({ history }: IProps) {
  const { title, imageUrl, calories, durationMinutes, watchedDate } = history;
  return (
